...
public class SeatController {
	...
	@GetMapping("/findavailableseats")
	public ResponseEntity<List<Seat>> AvailableSeatList() throws AccessForbiddenException, SeatNotFoundException {
		
		logger.info("-------List of Available Seats Fetched Successfully---------");
//		String str="AVAILABLE";
		return ResponseEntity.ok(seatService.availableSeats());
	}
	 ...
	 */
	@PutMapping("/block")
	public ResponseEntity<Seat> BlockASeat(@RequestBody Seat seat)
			throws AccessForbiddenException, SeatNotFoundException {
